...
var UIEvent = {
   ...
   * @const {string} RESIZE
   * @desc
   * 	Represents <code>'uiResize'</code>, fired when a {@link UIImage} changes its width and/or height
   * @example
   * UIEvent.RESIZE
   */
  RESIZE: "uiResize",
   ...
   * @desc
   * 	Represents an <code>'uiSliderUpdate'</code>, fired when a {@link UISlider} changes its value.
   * @example
